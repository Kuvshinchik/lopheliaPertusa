        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.php" class="brand-logo">
                ...
                {{--                               <img class="logo-compact" src="{{asset('dashboard/images/logo-text.png')}}" alt="">0

                          <img class="brand-title" src="{{asset('dashboard/images/logo-text.png')}}" alt="">--}}
    {{--            <p style="margin-top:0px;margin-bottom: 0px;margin-left: 10px;color: #f95b3e;">    Lophelia Pertusa </p>    --}}
             </a>
               ...
               <div class="deznav-scroll">
                   <ul class="metismenu" id="menu">
                       ...
                       <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                               ...
                               <span class="nav-text">Таблицы базы данных</span>
                           </a>
                           <ul aria-expanded="false">
...
--}}
                                                   <img class="svg_new" src="{{ asset('assets/images/svg/vk.svg')}}" alt="vk">
                                               </span>
                                               <div class="media-body">
                                                   <p class="fs-14 mb-2">Активность ВКонтакте</p>
...
--}}
                                                   <img class="svg_new" src="{{ asset('assets/images/svg/telegram.svg')}}" alt="telegram">
                                               </span>
                                               <div class="media-body">
                                                   <p class="fs-14 mb-2">Активность в Телеграм</p>
...
--}}
                                               <i class="fa fa-pinterest-p" style="font-size: xx-large;"></i>
                                               </span>
                                               <div class="media-body">
                                                   <p class="fs-14 mb-2">Активность на Pinterest</p>
                                                   <span class="title text-black font-w600">-30%</span>
                                               </div>
                                           </div>
                                           <div class="progress" style="height:5px;">
...
--}}
                                                   <img class="svg_new" src="{{ asset('dashboard/images/logo-yarmarka-masterov.png')}}" alt="telegram">
                                                </span>
                                               <div class="media-body">
                                                   <p class="fs-14 mb-2">Активность на Ярмарке мастеров</p>
                           ...
                           <div class="card">
                               <div class="card-header d-sm-flex d-block pb-0 border-0">
                                   <div class="mr-auto pr-3 mb-sm-0 mb-3">
                                       <h4 class="text-black fs-20">Активность на сайте</h4>
