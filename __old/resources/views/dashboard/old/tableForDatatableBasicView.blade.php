...
--}}
								<a href="{{route('adminTableEdit', ['alias'=>$alias . 'Edit', 'id'=>$zagolovkiAndTovars[0][$i]['id']])}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                <a href="{{route('adminTable', ['alias'=>'deleteStroke', 'zagolovk'=>$breadcrumb[1], 'id'=>$zagolovkiAndTovars[0][$i]['id']])}}" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                            </div>
                        </td>
                    </tr>
               @endfor
