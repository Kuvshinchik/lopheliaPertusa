                    ...
                    <div class="card">
                        <div class="card-header pb-0 border-0">
                            ...
                            <div class="mr-auto pr-3">
                                <h4 class="text-black fs-20">Просмотры</h4>
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="card">
                        <div class="card-header pb-0 border-0">
                            ...
                            <div class="mr-auto pr-3">
                                <h4 class="text-black fs-20">Лайки</h4>
                                <p class="fs-13 mb-0 text-black">Lorem ipsum dolor sit amet, consectetur</p>
                            </div>
                        </div>
                        <div class="card-body pb-0">
                ...
                <div class="col-xl-4">
                    <div class="card">
                        <div class="card-header pb-0 border-0">
                            ...
                            <div class="mr-auto pr-3">
                                <h4 class="text-black fs-20">Комментарии</h4>
                                <p class="fs-13 mb-0 text-black">Lorem ipsum dolor sit amet, consectetur</p>
                            </div>
                        </div>
                        <div class="card-body pb-0">
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header border-0 pb-0">
                                    <h4 class="text-black fs-20 mb-0">Трафик из соцсетей</h4>
                                </div>
                                <div class="card-body text-center">
                                    ...
                                    <ul class="d-flex flex-wrap">
                                        <li class="mr-5 mb-2">
                                            ...
                                            <span class="fs-12 text-black">Утро</span>
                                        </li>
                                        <li class="mr-5 mb-2">
                                            <svg class="mr-2" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="19" height="19" rx="9.5" fill="#FF9900"/>
                                            </svg>
                                            <span class="fs-12 text-black">День</span>
                                        </li>
                                        <li class="mr-5 mb-2">
                                            <svg class="mr-2" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="19" height="19" rx="9.5" fill="#E5E5E5"/>
                                            </svg>
                                            <span class="fs-12 text-black">Вечер</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header flex-wrap border-0 pb-0">
                                    <h4 class="text-black fs-20 mb-3">Воронка продаж</h4>
                                    <a href="workout-statistic.html" class="btn btn-outline-light btn-rounded">Включить раскрутку</a>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="d-flex align-items-center mb-sm-5 mb-3">
                                                        ...
                                                        <div>
                                                            <h4 class="fs-18 text-black">Посещение сайта (45%)</h4>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="d-flex align-items-center mb-sm-5 mb-3">
                                                        ...
                                                        <div>
                                                            <h4 class="fs-18 text-black">Просмотр товара (78%)</h4>
                                                            <span>56min/1hr</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="d-flex align-items-center mb-sm-0 mb-3">
                                                        ...
                                                        <div>
                                                            <h4 class="fs-18 text-black">Товар в корзине (66%)</h4>
                                                            <span>69km/20km</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="d-flex align-items-center mb-sm-0 mb-3">
                                                        ...
                                                        <div>
                                                            <h4 class="fs-18 text-black">Оформление покупки</h4>
                                                            <span>245/500</span>
                                                        </div>
                                                    </div>
                                                </div>
